...
func init() {
	...
	flag.IntVar(&threads, "n", threads, "number of worker threads (goroutines) to use")
	...
	flag.BoolVar(&verbose, "v", verbose, "display closed ports and reasons")
	flag.BoolVar(&grab_banners, "b", grab_banners, "grab and display banners from open ports")
